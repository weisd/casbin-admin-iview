  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/view/casbin/permission/index.vue')
      },
      {
        path: 'permission/add',
        name: 'permission/add',
        ...
        component: () => import('@/view/casbin/permission/add.vue')
      },
      {
        path: 'role',
        name: 'role',
        ...
        component: () => import('@/view/casbin/role/index.vue')
      },
      {
        path: 'role/add',
        name: 'role/add',
        ...
        component: () => import('@/view/casbin/role/add.vue')
      },
      {
        path: 'role/edit',
        name: 'role/edit',
